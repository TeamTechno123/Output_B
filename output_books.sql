...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2020 at 02:47 PM
...
(1, 'outbook', 'fghfgh dfgh', 'Kolhapur', 'Maharashtra', 'Kolhaput', 0, '111222', '9876543210', '9998887770', 'demo@email.com', 'www.ppp.com', '111', '222', '333', '444', '01-01-2019', '01-01-2021', '', '', '2020-04-01 13:28:45');
...
CREATE TABLE `item` (
  ...
  `in_sales` int(11) DEFAULT NULL COMMENT '0=No, 1=Yes',
  `item_sale_rate` double DEFAULT NULL,
  `item_sale_discount` double DEFAULT NULL,
  `item_sale_desc` text DEFAULT NULL,
  `sale_account_id` int(11) DEFAULT NULL,
  `in_purchase` int(11) DEFAULT NULL COMMENT '0=No, 1=Yes',
  `item_purchase_rate` double DEFAULT NULL,
  `item_purchase_itc` int(11) DEFAULT NULL COMMENT '0=No, 1=Yes',
  `item_purchase_desc` text DEFAULT NULL,
  `purchase_account_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `item_barcode` varchar(100) DEFAULT NULL,
  `tax_id` int(11) DEFAULT NULL COMMENT 'GST Tax %',
  `item_hsn` varchar(100) DEFAULT NULL,
  `item_category_id` int(11) DEFAULT NULL,
  `item_track_inv` int(11) DEFAULT NULL COMMENT '0=No, 1=Yes',
  `stock_alert_level` varchar(20) DEFAULT NULL,
  `item_status` int(11) NOT NULL DEFAULT 1 COMMENT '0=No, 1=Yes',
  `item_addedby` varchar(50) DEFAULT NULL,
  `item_added_date` varchar(20) DEFAULT NULL,
  `item_updateby` varchar(50) DEFAULT NULL,
...
INSERT INTO `item` (`item_id`, `company_id`, `item_no`, `item_name`, `item_type`, `in_sales`, `item_sale_rate`, `item_sale_discount`, `item_sale_desc`, `sale_account_id`, `in_purchase`, `item_purchase_rate`, `item_purchase_itc`, `item_purchase_desc`, `purchase_account_id`, `unit_id`, `item_barcode`, `tax_id`, `item_hsn`, `item_category_id`, `item_track_inv`, `stock_alert_level`, `item_status`, `item_addedby`, `item_added_date`, `item_updateby`, `item_update_date`) VALUES
(1, 1, 0, 'qqqq', 'Goods', 1, 1, 2, 'aaa', 1, 1, 3, 1, 'eee', 1, 3, '555', 0, '666', 2, 1, '755', 1, '1', '13-02-2020 11:50:03 ', '1', '13-02-2020 12:04:05 ');
...
CREATE TABLE `item_category` (
  ...
  `item_category_addedby` varchar(50) NOT NULL,
  `item_category_date` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `item_category` (`item_category_id`, `company_id`, `item_category_name`, `item_category_addedby`, `item_category_date`) VALUES
(2, 1, 'Wertyu', '1', '2020-02-13 11:09:57');
...
CREATE TABLE `supplier` (
  ...
  `supplier_display_name` varchar(250) DEFAULT NULL,
  `supplier_gstin` varchar(50) DEFAULT NULL,
  `supplier_pan` varchar(50) DEFAULT NULL,
  `composition_scheme` int(11) NOT NULL DEFAULT 0 COMMENT '0=No, 1=Yes',
  `supplier_tds` double DEFAULT NULL,
  `supplier_mobile` varchar(20) DEFAULT NULL,
  `supplier_phone` varchar(20) DEFAULT NULL,
  `supplier_email` varchar(150) DEFAULT NULL,
  `tags_id` int(11) DEFAULT NULL,
  `supplier_addr1` text DEFAULT NULL,
  `supplier_addr2` text DEFAULT NULL,
  `supplier_city` varchar(150) DEFAULT NULL,
  `supplier_pin` varchar(10) DEFAULT NULL,
  `country_id` int(11) DEFAULT NULL,
  `state_id` int(11) DEFAULT NULL,
  `is_addr_same` int(11) NOT NULL DEFAULT 1 COMMENT '0=No, 1=Yes',
  `supplier_s_addr1` text DEFAULT NULL,
  `supplier_s_addr2` text DEFAULT NULL,
  `supplier_s_city` varchar(150) DEFAULT NULL,
  `supplier_s_pin` varchar(10) DEFAULT NULL,
  `country_s_id` int(11) DEFAULT NULL,
  `state_s_id` int(11) DEFAULT NULL,
  `supplier_status` int(11) NOT NULL DEFAULT 1 COMMENT '0=Inactive, 1=Active',
  `supplier_addedby` varchar(50) DEFAULT NULL,
  `supplier_added_date` varchar(20) DEFAULT NULL,
  `supplier_updateby` varchar(50) DEFAULT NULL,
  `supplier_update_date` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `supplier` (`supplier_id`, `company_id`, `supplier_no`, `supplier_company`, `supplier_name`, `supplier_display_name`, `supplier_gstin`, `supplier_pan`, `composition_scheme`, `supplier_tds`, `supplier_mobile`, `supplier_phone`, `supplier_email`, `tags_id`, `supplier_addr1`, `supplier_addr2`, `supplier_city`, `supplier_pin`, `country_id`, `state_id`, `is_addr_same`, `supplier_s_addr1`, `supplier_s_addr2`, `supplier_s_city`, `supplier_s_pin`, `country_s_id`, `state_s_id`, `supplier_status`, `supplier_addedby`, `supplier_added_date`, `supplier_updateby`, `supplier_update_date`) VALUES
(1, 1, NULL, 'a', 's', 'd', 'f', 'g', 0, 11, '9876543210', '9966558833', 'dsfg@df.nnn', 3, 'xcb', 'fsdfdf', 'vb', '666333', 101, 22, 0, 'hkljhkl', 'fsdfdf', 'vb', '111222', 101, 22, 1, '1', '13-02-2020 10:16:30 ', '1', '13-02-2020 10:16:51 ');
...
(3, 1, 'dsf asdf', '1', '2020-02-13 06:49:42'),
(4, 1, 'aerfsdvf asdfasdf', '1', '2020-02-13 06:49:47');
...
(2, 1, 'Nos', '1', '2020-02-13 10:48:53'),
(3, 1, 'KGS', '1', '2020-02-13 10:49:15'),
(4, 1, 'LTR', '1', '2020-02-13 10:49:21');
...
--
ALTER TABLE `supplier`
  ADD CONSTRAINT `supplier_ibfk_1` FOREIGN KEY (`tags_id`) REFERENCES `tags` (`tags_id`) ON UPDATE CASCADE;
COMMIT;
