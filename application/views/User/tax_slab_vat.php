            ...
            <div class="card card-default">
              ...
              <form class="m-0 input_form" id="form_action" salt="form" action="" method="post">
                <div class="card-body row">
                  ...
                  <div class="form-group col-md-6 select_sm">
                    <label>Select Taxation Type</label>
                    <select class="form-control select2" name="state_id" id="state_id" data-placeholder="Select Taxation Type" required>
                  ...
                  <div class="form-group col-md-6">
                    <label>Commdoty Code</label>
                    <input type="text" class="form-control form-control-sm" name="service_name" id="service_name" value="<?php if(isset($service_name)){ echo $service_name; } ?>" placeholder="Commdoty Code" required>
                  </div>

                  <div class="form-group col-md-4">
                    <label>Tax Percentage %</label>
                    <input type="text" class="form-control form-control-sm" name="service_name" id="service_name" value="<?php if(isset($service_name)){ echo $service_name; } ?>" placeholder="Tax Percentage %" required>
                  </div>

                  <div class="form-group col-md-4">
                    <label>Surcharge</label>
                    <input type="text" class="form-control form-control-sm" name="service_charges" id="service_charges" value="<?php if(isset($service_charges)){ echo $service_charges; } ?>" placeholder="Surcharge" required>
                  </div>
