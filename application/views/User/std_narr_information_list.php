      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mt-1">
            <h4>Standard Narration  List</h4>
          </div>
          <div class="col-sm-6 mt-1 text-right">
              <a href="<?php echo base_url(); ?>User/std_narr_information" class="btn btn-sm btn-primary">Add Standard Narration</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
