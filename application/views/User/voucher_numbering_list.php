      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mt-1">
            <h4>Voucher Numbering  List</h4>
          </div>
          <div class="col-sm-6 mt-1 text-right">
              <a href="<?php echo base_url(); ?>User/voucher_numbering" class="btn btn-sm btn-primary">Add Voucher Numbering</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
