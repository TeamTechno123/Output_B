          ...
          <div class="col-md-8 offset-md-2">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title"> Bank Entry  Information</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="m-0 input_form" id="form_action" role="form" action="" method="post">
                <div class="card-body row">
                    ...
                    <select class="form-control select2" name="reg_type" id="reg_type" data-placeholder="Select Bank" required>
                ...
                <select class="form-control select2" name="reg_type" id="reg_type" data-placeholder="Select Account No." required>
                ...
                <div class="card-footer row">
                  <div class="col-md-12 text-center">
                    ...
                    <?php } ?>
                    <a href="<?php echo base_url() ?>Transaction/bank_entry_list" class="btn btn-default ml-4">Cancel</a>
                  </div>
                </div>
              </form>
            </div>
