      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 text-center mt-2">
            <h1>Purchase Return Delivery Challan Information</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Add Purchase Return Delivery Challan Information </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            ...
            <div class="form-group col-md-2">
              <label>Purchase Return Challan No.</label>
              <input type="text" class="form-control form-control-sm" name="bill_no"  value="" placeholder="Purchase Return Challan No." required>
            </div>
