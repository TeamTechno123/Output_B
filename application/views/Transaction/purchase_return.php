      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 text-center mt-2">
            <h1>Purchase Return Information</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Add Purchase Return Information </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              ...
              <select class="form-control select2" name="sale_type" id="sale_type" data-placeholder="Select Purchase Type" required>
            ...
            <div class="form-group col-md-2">
              ...
              <input type="text" class="form-control form-control-sm" name="bill_no"  value="<?php if(isset($bill_no)){ echo $bill_no; } else{ echo date('d-m-Y'); } ?>" placeholder="Original INV No." required>
            </div>



            <div class="form-group col-md-2">
              <label>Original INV Date</label>
              <input type="text" class="form-control form-control-sm" name="due_date" id="date1" data-target="#date1" data-toggle="datetimepicker" value="<?php if(isset($due_date)){ echo $due_date; } else{ echo date('d-m-Y'); } ?>" placeholder="Original INV Date" required>
            </div>

            <div class="form-group col-md-2">
              <label>Purchase Return No.</label>
              <input type="text" class="form-control form-control-sm" name="bill_no"  value="<?php if(isset($bill_no)){ echo $bill_no; } else{ echo date('d-m-Y'); } ?>" placeholder="Purchase Return No." required>
            </div>
