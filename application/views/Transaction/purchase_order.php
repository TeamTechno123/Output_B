          ...
          <div class="col-md-12">
            ...
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Add Purchase Order Information </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            ...
            <div class="form-group col-md-2">
              ...
              <input type="text" class="form-control form-control-sm" name="bill_no"  value="<?php if(isset($bill_no)){ echo $bill_no; } else{ echo date('d-m-Y'); } ?>" placeholder="Purchase Order No." required>
            </div>
