      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mt-1">
            <h4>Purchase Return Challan Information</h4>
          </div>
          <div class="col-sm-6 mt-1 text-right">
            <a href="<?php echo base_url(); ?>Transaction/purchase_return_challan" class="btn btn-sm btn-primary">Add Purchase Return Challan</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
