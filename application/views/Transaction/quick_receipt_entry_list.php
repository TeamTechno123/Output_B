      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mt-1">
            <h4>Quick Receipt Entry Information  List</h4>
          </div>
          <div class="col-sm-6 mt-1 text-right">
              <a href="<?php echo base_url(); ?>Transaction/quick_receipt_entry" class="btn btn-sm btn-primary">Add Quick Receipt Entry</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
